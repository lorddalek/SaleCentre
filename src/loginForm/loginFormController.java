...
public class loginFormController {
    ...
    public void handleLoginButton() throws Exception{
        ...
        boolean userExists = dbc.checkUserExists(retrieveID, passwordstring);
        if(userExists){
            dbc.close();
            Stage stage = (Stage) btnLogin.getScene().getWindow();
            stage.close();
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/mainForm/mainForm.fxml"));
            Parent root = loader.load();
            mainForm.mainFormController controller = loader.getController();
            String userName = dbc.getUserName(retrieveID);
